...
{
    public class BA_Command : CommandBase_RM
    {
...
#region "Public Defines"
        ...
        // </summary>
        // <remarks></remarks>
        public const string COMMAND_STRING = "BA";
...
#region "Public Property"
        ...
        public HoldType[] HoldTypeList
        {
            get
            {
                HoldType[] retlist = new HoldType[] { HoldType.BOTTOM, HoldType.BOTTOM, 
                                                      HoldType.BOTTOM, HoldType.BOTTOM,
                                                      HoldType.BOTTOM, HoldType.BOTTOM,
                                                      HoldType.BOTTOM, HoldType.BOTTOM,
                                                      HoldType.BOTTOM, HoldType.BOTTOM};
                ...
                if (SubCommand == SubCommandType.W && !IsResponse)
                {
                    ...
                    {
                        retlist[i] = (tmpValStr[i] == '0' ? HoldType.BOTTOM : HoldType.FIRST);
                    }
            ...
            set
            {
                if (!IsResponse && SubCommand == SubCommandType.W)
                {
                    ...
                    {
                        tmpValStr += (value[i] == HoldType.FIRST ? '0' : '1');
                    }
...
#region "Public Methods"
        ...
        // <returns></returns>
        // <remarks></remarks>
        public static new BA_Command CreateResponseData(byte[] responcedata)
        {
