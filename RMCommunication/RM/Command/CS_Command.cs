...
{
    public class CS_Command : CommandBase_RM
    {
...
#region "Public Defines"
        ...
        // </summary>
        // <remarks></remarks>
        public const string COMMAND_STRING = "CS";
...
#region "Public Methods"
        ...
        // <returns></returns>
        // <remarks></remarks>
        public static new CS_Command CreateResponseData(byte[] responcedata)
        {
            CS_Command ret = new CS_Command();
        ...
        // <returns></returns>
        // <remarks></remarks>
        public static CS_Command CreateSendData(SubCommandType sendtype)
        {
            CS_Command ret = new CS_Command();
